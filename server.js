...
/* 
This is a server file for a web app. 
It imports the main app file and then use the app.listen method to start the server, 
listening on the port specified in the process.env.PORT variable. 
